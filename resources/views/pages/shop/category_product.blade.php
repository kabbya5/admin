...
@section('content')
  ...
  <div class="product-view">
    <div class="container">
      <h4 class="text-center text-bold text-uppercase text-dark mt-4">{{$cat->name}} Total product <span class=" badge rounded-pill bg-warning text-dark"> {{$total_product}} </span> </h4>
      ...
      <h4 class="text-center text-bold text-uppercase text-dark mt-4"> Shop By Relative Brand </h4>
        <div class="shop-by-category mt-2">
          <div class="owl-carousel carousel-category owl-theme">
            ...
            $brand = DB::table('brands')->where('id', $brand_product->brand_id)->first();
            @endphp
            <div class="item">  
