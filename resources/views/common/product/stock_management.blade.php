        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-md-flex align-items-center">
                    <div>
                        <h4 class="card-title"> All Stock Out Products </h4>
                        <h5 class="card-subtitle"> Overview Latest StockOut Products </h5>
                    </div>
                </div>
                <!-- title -->
                    ...
                    <table class="table v-middle">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <a href="/admin/product/view/{{$product->id}}" class="btn btn-info"> <i class="fas fa-eye"></i></a>
