        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    <li class=""> 
                        <a class="nav-link text-left active"  href="{{route('admin.dashboard')}}"
                    ...
                    <nav class="navbar navbar-expand navbar-light my-navbar">
                        ...
                        <!-- Nav Item - Search Dropdown (Visible Only XS) -->
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-icon dropdown" href="{{route('all.order')}}" id="alertsDropdown" >
                                    <div class="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell align-middle"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
                                        @if (!$new_orders->count() == null)
                                            <span class="indicator">{{$new_orders->count()}}</span>
                                        @endif  
                                    </div>
                                </a>
                            <!-- Nav Item - Messages -->
                            <li class="nav-item">
                                <a class="nav-link " href="{{route('all.contact')}}">
                                    ...
                                    <!-- Counter - Messages -->
                                    @if (!$new_message->count() == null)
                                    <span class="badge badge-danger" style="margin:-10px; -5px 0 0;"> 
                                        {{$new_message->count()}} 
                                    </span>  
                                    @endif
                                </a>
